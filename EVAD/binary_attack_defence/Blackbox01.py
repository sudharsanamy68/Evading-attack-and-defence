...
Train_folder = "/home/subash/Desktop/phase2/Dataset/Virus/Virus train/Zeroaccess"  # dir of malware samples for generating adversarial patch
Test_folder = "/home/subash/Desktop/phase2/Dataset/Virus/Virus test/Zeroaccess"  # dir of malware samples for evaluating adversarial patch
...
for epoch in range(3):
    ...
    for sample, label in zip(Train_X, Train_y):
        ...
        # Ensure that indexes_to_perturb are within bounds
        indexes_to_perturb = [i for i in indexes_to_perturb if i < len(sample)]
